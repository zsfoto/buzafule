<div class="box">
	<h2><a href="#" id="toggle-forms"><?php echo __('Photo'); ?></a></h2>
	<div class="block" id="forms">
		<fieldset class="view">
			...
			<ul class="viewactionlist">
				...
				<li class="viewactionlistelement"><?php echo $this->Html->link(__('Módosít'), array('action' => 'edit', $photo['Photo']['id']), array('class'=>'viewactionlink')); ?> </li>
				<li class="viewactionlistelement"><?php echo $this->Html->link(__('Új'), array('action' => 'add'), array('class'=>'viewactionlink')); ?> </li>
				<li class="viewactionlistelement"><?php echo $this->Form->postLink(__('Töröl'), array('action' => 'delete', $photo['Photo']['id']), array('class'=>'viewactionlink'), __('Valóban törölni szeretné a rekordot? ID: %s', $photo['Photo']['id'])); ?> </li>
			</ul>
		</fieldset>
	</div>
</div>
